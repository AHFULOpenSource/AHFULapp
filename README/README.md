...
- [Members](User/README-Users.md) -- Both gym and non-gym members fall under this type of account made to privately track your workout progress.
- [Developers](Developer/README-Developers.md) -- Has full access to the application to create useful features or fix failing features.
- [Admins](Admin/README-Admin.md) -- Has access to monitor member accounts and ban individuals not following terms of service.
- [Gym Owners & Personal Trainers](GymOwners&PersonalTrainers/README-GymOwners&PersonalTrainers.md) -- Have the ability to create events, workouts, workout templates, schedule workouts, and edit workout calendars.

## Reporting Issues

Each user type has its own reporting guide with links to the appropriate issue templates:

- [Members: Reporting an Issue](User/ReportingAnIssue.md)
- [Developers: Reporting an Issue](Developer/ReportingAnIssue.md)
- [Admins: Reporting an Issue](Admin/ReportingAnIssue.md)
- [Gym Owners & Personal Trainers: Reporting an Issue](GymOwners&PersonalTrainers/ReportingAnIssue.md)
